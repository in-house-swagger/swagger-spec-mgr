...
public interface BranchesApi {
  ...
  @ApiResponses(value = {
      @ApiResponse(code = 200, message = "successful operation",
          response = BranchesApiModelGen.class),
  ...
  @ApiOperation(value = "/branches/{branch} POST", notes = "", response = BranchesApiModelGen.class,
      tags = {})
  @ApiResponses(
  ...
  @ApiOperation(value = "/branches/{branch} PUT", notes = "", response = BranchesApiModelGen.class,
      tags = {})
  @ApiResponses(
  ...
  @ApiOperation(value = "/switch/{branch} POST", notes = "", response = BranchesApiModelGen.class,
      tags = {})
  @ApiResponses(
      value = {@ApiResponse(code = 400, message = "Invalid ID supplied", response = Void.class),
          @ApiResponse(code = 404, message = "Branch not found", response = Void.class)})
