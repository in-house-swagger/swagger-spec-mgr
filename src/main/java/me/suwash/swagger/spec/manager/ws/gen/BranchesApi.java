...
public interface BranchesApi {
    ...
    ResponseEntity<Identifiable<Link>> getBranches(
    ...
    @ApiOperation(value = "Add a branch with id", notes = "", response = Void.class, tags = {})
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "rename an existing branch", notes = "", response = Void.class, tags = {})
    @ApiResponses(value = {
        @ApiResponse(code = 400, message = "Invalid ID supplied", response = Void.class),
        @ApiResponse(code = 404, message = "branch not found", response = Void.class),
    ...
    ResponseEntity<Void> deleteBranchById(
        HttpServletRequest request,
        @ApiParam(value = "user name for commit") @RequestHeader(value = "x-commit-user", required = false) final String commitUser,
        @ApiParam(value = "email address for commit") @RequestHeader(value = "x-commit-email", required = false) final String commitEmail,
        @ApiParam(value = "ID of branch to delete", required = true) @PathVariable("branch") final String branch);

    @ApiOperation(value = "Merge source branch to target branch", notes = "", response = Void.class, tags = {})
    @ApiResponses(value = {
        @ApiResponse(code = 400, message = "Invalid ID supplied", response = Void.class),
        @ApiResponse(code = 404, message = "branch not found", response = Void.class),
        @ApiResponse(code = 405, message = "Validation exception", response = Void.class)
    ...
    @ApiOperation(value = "Switch to a branch", notes = "", response = Void.class, tags = {})
    @ApiResponses(value = {
        @ApiResponse(code = 400, message = "Invalid ID supplied", response = Void.class),
        @ApiResponse(code = 404, message = "Branch not found", response = Void.class)
    })
