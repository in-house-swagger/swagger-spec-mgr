...
public final class SwaggerSpecUtils {
    ...
    public static String writeSplit(
        ...
        return SwaggerSpecUtilsSplit.recursiveSplit(value, outputRootDirPath, FILENAME_MERGED, ignorePatternList);
    }

    private static void convertPatternList(final List<String> ignoreRegexList, final String outputDirPath, final String specId, List<Pattern> ignorePatternList) {
    ...
    private static Pattern convertPattern(final String ignoreRegex, final String outputDirPath, final String specId) {
        // 出力ディレクトリを付与
