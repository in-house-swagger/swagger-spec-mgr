...
//        .andDo(MockMvcResultHandlers.print())
    ...
    mockMvc
        .perform(withCommitInfo(post("/branches/NotExist"), commitInfo)
    ...
    mockMvc
        .perform(withCommitInfo(put("/branches/NotExist"), commitInfo)
            .contentType(requestMediaType.value()))
        // .andDo(MockMvcResultHandlers.print())
        .andExpect(status().isBadRequest());
    ...
    result = mockMvc
        .perform(withCommitInfo(get("/branches"), commitInfo).contentType(requestMediaType.value()))
        // .andDo(MockMvcResultHandlers.print())
    ...
    result = mockMvc
        .perform(withCommitInfo(get("/branches/develop"), commitInfo)
            .contentType(requestMediaType.value()))
        // .andDo(MockMvcResultHandlers.print())
    ...
    result = mockMvc
        .perform(withCommitInfo(post("/branches/develop?object=master"), commitInfo)
            .contentType(requestMediaType.value()))
        // .andDo(MockMvcResultHandlers.print())
    ...
    result = mockMvc
        .perform(withCommitInfo(post("/branches/feature/1/someUser?object=develop"), commitInfo)
            .contentType(requestMediaType.value()))
        // .andDo(MockMvcResultHandlers.print())
        .andExpect(status().isCreated()).andReturn();
    ...
    result = mockMvc
        .perform(withCommitInfo(get("/branches/feature/1/someUser"), commitInfo)
            .contentType(requestMediaType.value()))
        // .andDo(MockMvcResultHandlers.print())
        .andExpect(status().isOk()).andReturn();
    assertThat(result.getResponse().getContentAsString(), containsString("feature/1/someUser"));
    ...
    result =
        mockMvc
            .perform(withCommitInfo(put("/branches/feature/1/someUser?to=feature/2/someUser"),
                commitInfo).contentType(requestMediaType.value()))
            // .andDo(MockMvcResultHandlers.print())
            .andExpect(status().isOk()).andReturn();
    ...
    result = mockMvc
        .perform(withCommitInfo(post("/switch/feature/2/someUser"), commitInfo)
            .contentType(requestMediaType.value()))
        // .andDo(MockMvcResultHandlers.print())
        .andExpect(status().isOk()).andReturn();
    assertThat(result.getResponse().getContentAsString(), containsString("feature/2/someUser"));
    ...
    result = mockMvc
        .perform(withCommitInfo(delete("/branches/feature/2/someUser"), commitInfo)
            .contentType(requestMediaType.value()))
        // .andDo(MockMvcResultHandlers.print())
        .andExpect(status().isOk()).andReturn();
    ...
    result = mockMvc
        .perform(withCommitInfo(delete("/branches/develop"), commitInfo)
            .contentType(requestMediaType.value()))
        // .andDo(MockMvcResultHandlers.print())
        .andExpect(status().isOk()).andReturn();
    assertThat(result.getResponse().getContentAsString(), is(StringUtils.EMPTY));
