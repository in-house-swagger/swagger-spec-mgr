...
public class SpecMgrTestUtils {
    ...
    private static void assertErrorsContainsStrings(final List<String> actualMsgList, final String[] expectStrings) {
    ...
    private static boolean containsString(final List<String> actualMsgList, final String expectMsg) {
        for (int idx = 0; idx < actualMsgList.size(); idx++) {
            ...
            if (curActualMsg.contains(expectMsg)) return true;
        }
        return false;
    }
